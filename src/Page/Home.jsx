...
const Home = () => {
  return (
    <div style={{ paddingTop: "138px" }} className="d-none d-lg-block">
      <div className="mb-3">
        <Swiper
          slidesPerView={3}
          spaceBetween={15}
      ...
      <div className="container-fluid m-0 mb-3">
        <div className="row">
          <div className="col-12 p-0">
            <Link><img src="https://images.bewakoof.com/uploads/grid/app/thin-banner-desktop-deadpool-1721970853.jpg" style={{ width: "100%" }}></img></Link>
          </div>
      ...
      <div className="container-fluid">
        <div className="row">
          <div className="col-12 p-0">
            <ul className="list-unstyled d-flex">
              <Link style={{ width: "30%" }}> <li><img src="https://images.bewakoof.com/uploads/grid/app/TrendingCategory-Carousel-600x750-Oversized-T-Shirts-Women-1719825670.jpg" style={{ width: "100%" }}></img></li></Link>
              <Link style={{ width: "30%" }}><li><img src="https://images.bewakoof.com/uploads/grid/app/TrendingCategory-Carousel-600x750-Boyfriend-T-Shirts-Women-1719825670.jpg" style={{ width: "100%" }}></img></li></Link>
              <Link style={{ width: "30%" }}><li><img src="https://images.bewakoof.com/uploads/grid/app/TrendingCategory-Carousel-600x750-new-Women-3-1717767106.jpg" style={{ width: "100%" }}></img></li></Link>
              <Link style={{ width: "30%" }}><li><img src="https://images.bewakoof.com/uploads/grid/app/TrendingCategory-Carousel-600x750-Cargos-Women-1719835750.jpg" style={{ width: "100%" }}></img></li></Link>
              <Link style={{ width: "30%" }}><li><img src="https://images.bewakoof.com/uploads/grid/app/TrendingCategory-Carousel-600x750-Joggers-1718888705.jpg" style={{ width: "100%" }}></img></li></Link>
              <Link style={{ width: "30%" }}><li><img src="https://images.bewakoof.com/uploads/grid/app/TrendingCategory-Carousel-600x750-new-Women-6-1717767108.jpg" style={{ width: "100%" }}></img></li></Link>
            </ul>
          </div>
      ...
      <div className="container-fluid">
        <div className="row">
          <div className="col-12 p-0">
            <ul className="list-unstyled d-flex">
              <Link style={{ width: "30%" }}> <li><img src="https://images.bewakoof.com/uploads/grid/app/TrendingCategory-Carousel-600x750-new-Women-7-1717767108.jpg" style={{ width: "100%" }}></img></li></Link>
              <Link style={{ width: "30%" }}><li><img src="https://images.bewakoof.com/uploads/grid/app/TrendingCategory-Carousel-600x750-Dresses-1718888706.jpg" style={{ width: "100%" }}></img></li></Link>
              <Link style={{ width: "30%" }}><li><img src="https://images.bewakoof.com/uploads/grid/app/TrendingCategory-Carousel-600x750-new-Women-9-1717767109.jpg" style={{ width: "100%" }}></img></li></Link>
              <Link style={{ width: "30%" }}><li><img src="https://images.bewakoof.com/uploads/grid/app/TrendingCategory-Carousel-600x750-Co-Ords-1718888706.jpg" style={{ width: "100%" }}></img></li></Link>
              <Link style={{ width: "30%" }}><li><img src="https://images.bewakoof.com/uploads/grid/app/TrendingCategory-Carousel-600x750-Shirts-1718888707.jpg" style={{ width: "100%" }}></img></li></Link>
              <Link style={{ width: "30%" }}><li><img src="https://images.bewakoof.com/uploads/grid/app/TrendingCategory-Carousel-600x750-new-Women-12-1717767111.jpg" style={{ width: "100%" }}></img></li></Link>
            </ul>
          </div>
