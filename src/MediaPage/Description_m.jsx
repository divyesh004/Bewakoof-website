...
import { Accordion, AccordionItem, AccordionButton, AccordionPanel, Box, Text, styled } from '@chakra-ui/react';
    ...
    <div className="container">
      <div className="row">
        <div className="col-12 d-flex justify-content-between flex-column pt-2">
          <div className="slideshow-container d-flex flex-column">
            <div id="lens"></div>
            <div id="result"></div>
            <div className="row">
              <div id="slideshow-items-container" >
                {images.map((src, index) => (
                  <img
                    key={index}
                    src={src}
                    className={`slideshow-items ${index === activeIndex ? 'active' : ''} img-fluid`} style={{ width: "100%", height: "90%" }}
                    alt=""
                  />
                ))}
              </div>
